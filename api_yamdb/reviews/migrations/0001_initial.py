# Generated by Django 2.2.16 on 2022-07-04 18:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'admin'), ('user', 'user'), ('moderator', 'moderator')], default='user', max_length=9, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Ваша оценка должна быть от 1 до 10 (целое число)'), django.core.validators.MaxValueValidator(10, 'Ваша оценка должна быть от 1 до 10 (целое число)')], verbose_name='Оценка')),
